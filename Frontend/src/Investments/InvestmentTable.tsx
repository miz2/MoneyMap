...
const InvestmentTable: React.FC = () => {
  ...
  }, [deleteInvestment, enqueueSnackbar]);
  ...
  const exportToCSV = useCallback(() => {
    ...
    const csvRows = [];
    const headers = ['ID', 'Description', 'Start Date', 'End Date', 'Amount', 'Firm'];
    ...
    investments.forEach((investment) => {
      const row = [
        ...
        new Date(investment.startDate).toLocaleDateString(), // Format date
        new Date(investment.endDate).toLocaleDateString(), // Format date
        investment.amount.toLocaleString(), // Removed $ symbol
        investment.firm,
      ];
  ...
  const columns: Array<Column<Investment>> = useMemo(
    () => [
      { Header: 'ID', accessor: '_id' }, // Added column for ID
      ...
      { Header: 'Amount', accessor: 'amount', Cell: ({ value }: CellProps<Investment>) => value.toLocaleString() }, // Removed $ symbol
